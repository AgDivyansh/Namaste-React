...
{
    // some basics of React how element is created in React 
    ...
    // const Heading = () => (<div>
    //     <h1>Heading with the help of React Component.</h1>
    // </div>)
    // console.log(Heading);
...
// config driven ui -> ui changes according to the data which we get from the backend or api request controlling the ui on the basics of data (pai data!)
const Header = () => {
    return (
        <div
            className="header"
        >
            ...
            >
                ...
                <img src="https://dynamic.brandcrowd.com/asset/logo/05f4c8da-002c-45db-bbee-4337be734701/logo-search-grid-2x?logoTemplateVersion=2&v=638884979608570000&text=Namaste+Food&layout=auto&colorpalette=grayscale" alt="Logo" />
            </div>
    ...
    return (
        <div
            ...
            <img className="res-logo"
                src={"https://media-assets.swiggy.com/swiggy/image/upload/" + resturantDetails.info.cloudinaryImageId}
                alt="res-logo" />
            {/* <div
                className="res-details"
            > */}
            <h3>{resturantDetails.info.name}</h3>
            <h4>{resturantDetails.info.cuisines.join(", ")}</h4>
            <h4>{resturantDetails.info.avgRating} starts</h4>
            <h4>{resturantDetails.info.costForTwo}</h4>
            <h4> average delivery in {resturantDetails.info.sla.deliveryTime} min.</h4>
            {/* </div> */}
    ...
    return (
        ...
        >
            ...
            >
                ...
                <RestaurantCard
                resName= "Roti, Kulcha aur Nan"
                cuisine= "North Indian, Roti, Kulcha, Nan"
                />*/}
                {/* <RestaurantCard
                    resName= "Punjabi Dhabha"
                    cuisine= "Punjabi "
                />  */}
                {resturant.map((res) => { 
                    return <RestaurantCard  resturantDetails={res} key={res.info.name} />
                })}
            </div>
        </div>
    );
